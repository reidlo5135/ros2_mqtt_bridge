...
ros2_mqtt_bridge::MQTTConnection::MQTTConnection(
    ...
    std::shared_ptr<ros2_mqtt_bridge::RCLConnection> rcl_connection_ptr) : rcl_node_ptr_(rcl_node_ptr),
...
void ros2_mqtt_bridge::MQTTConnection::bridge_rcl_to_mqtt()
{
     ...
     */
    std::function<void()> rcl_bridge_lambda = [this,
                                               ...
                                               &rcl_already_ignored_services_set]() -> void
    {
